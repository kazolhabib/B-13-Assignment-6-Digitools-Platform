    ...
    <section className="py-16 md:py-25 bg-white" id="pricing">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 items-stretch max-w-6xl mx-auto">
          {/* Starter Plan */}
          <div className="bg-[#F9FAFC] rounded-2xl p-6 border border-[#F2F2F2] shadow-[0_8px_30px_rgb(0,0,0,0.04)] hover:shadow-[0_8px_30px_rgb(0,0,0,0.12)] transform hover:scale-105 transition-all duration-300 flex flex-col h-full">
            ...
            <button className="w-full py-4 px-4 bg-linear-to-r from-blue-700 to-purple-500 text-white font-semibold rounded-xl transition-colors duration-300 mt-auto hover:opacity-90 cursor-pointer">
              Get Started Free
            </button>
          </div>
          ...
          <div className="bg-linear-to-r from-blue-700 to-purple-500 rounded-2xl p-6 relative flex flex-col h-full transform hover:scale-105 transition-all duration-300">
            ...
            <button className="w-full py-4 px-4 bg-white font-bold rounded-xl transition-colors duration-300 shadow-sm mt-auto cursor-pointer">
              <span className='bg-linear-to-r from-blue-700 to-purple-500 bg-clip-text text-transparent'>Start Pro Trial</span>
            </button>
          </div>

          {/* Enterprise Plan */}
          <div className="bg-[#F9FAFC] rounded-2xl p-6 border border-gray-100 shadow-[0_8px_30px_rgb(0,0,0,0.04)] hover:shadow-[0_8px_30px_rgb(0,0,0,0.12)] transform hover:scale-105 transition-all duration-300 flex flex-col h-full">
